# Part II: Kimurai - A complete Ruby web scraping
# ===============================================
require 'kimurai'
...
class JobScraper < Kimurai::Base
    ...
    def scrape_page
        ...
        returned_jobs = doc.css('td.resultContent')
    ...
    def parse(response, url:, data: {})
        #response: the Nokogiri::HTML object
        #data: storage for passing data between requests
        10.times do
            scrape_page
